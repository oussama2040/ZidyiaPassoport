...
function AdminIssueCertifcate({ organizationId }) {
    ...
    useEffect(() => {
      const fetchFormFields = async () => {
        try {
          const response = await axios.get(`http://localhost:5000/admin/issuefilledform/${organizationId}`,
...
export default AdminIssueCertifcate
